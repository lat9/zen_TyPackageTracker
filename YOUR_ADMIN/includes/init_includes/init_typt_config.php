...
define('TY_TRACKER_CURRENT_VERSION', '4.1.0-beta1');
...
if (!defined('TY_TRACKER_VERSION')) {
    ...
    $db->Execute(
        "INSERT IGNORE INTO " . TABLE_CONFIGURATION . "
         ...
         VALUES
            ('Current Ty Package Tracker Version', 'TY_TRACKER_VERSION', '0.0.0', 'Version number.', $cgi, 0, now(), NULL, 'zen_cfg_select_option([\'0.0.0\'],'),
            ...
            ('<em>Edit Orders</em> Mode', 'TY_TRACKER', 'False', 'Versions prior to v4.6.0 include the package-tracker handling, but follow-on versions do not.  Set this value to <em>True</em> for EO versions &lt; 4.6.0 and <em>False</em> (the default) for EO versions &gt;= 4.6.0.', $cgi, 175, now(), NULL, 'zen_cfg_select_option([\'True\', \'False\'],')"
    );
    ...
    $db->Execute(
        "UPDATE " . TABLE_CONFIGURATION . "
            SET configuration_value = '" . TY_TRACKER_CURRENT_VERSION . "',
                set_function = 'zen_cfg_select_option([\'" . TY_TRACKER_CURRENT_VERSION . "\'],'
